package com.example.takewhile.dropwhile;
...
public class TakeWhileDropWhileWithoutSorting {
    ...
    public static List<String> getStocksBelowFiveHundredFilter(List<Stock> stocks) {
        return stocks.stream()
                .filter(TakeWhileDropWhileWithoutSorting::isStockLessThanFiveHundred)
                .map(Stock::getName)
    ...
    public static List<String> getStocksBelowFiveHundred(List<Stock> stocks) {
        return stocks.stream()
                ...
                .takeWhile(TakeWhileDropWhileWithoutSorting::isStockLessThanFiveHundred)
                .map(Stock::getName)
                .collect(Collectors.toList());
    }
    ...
    public static List<String> getStocksAboveFiveHundred(List<Stock> stocks) {
        return stocks.stream()
                .dropWhile(TakeWhileDropWhileWithoutSorting::isStockLessThanFiveHundred)
                .map(Stock::getName)
                .collect(Collectors.toList());
    }
