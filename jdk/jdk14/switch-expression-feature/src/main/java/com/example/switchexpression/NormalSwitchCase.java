...
public class NormalSwitchCase {
    ...
    public static void main(String[] args) {
        ...
        budget = 1000000;
        int numberOfBedRoomsUsingMixedStyleAgainFallThrough = normalSwitchCase.getNumberOfRoomsUsingExpressionColonLabelFallThrough(budget);
        System.out.println("You can get a house with " + numberOfBedRoomsUsingMixedStyleAgainFallThrough + " room(s) in this budget");
    ...
    public int getNumberOfRoomsUsingExpressionColonLabelFallThrough(int budget) {
        return switch (budget) {
            case 1000000: {
                System.out.println("Fall through example using colon");
            }
            case 2000000, 3000000: {
                int finalPrice = (budget == 3000000) ? budget - 100000 : budget;
                System.out.println("Final price after discount " + finalPrice);
